...
class FrmOS(ctk.CTkToplevel):
    ...
    def __init__(self, master, id_orc=None, on_save_callback=None, dados_precarregados=None):
        ...
        # Sequência Sagrada de Estabilização de Foco
        self.update()
        ...
        self.lift()
        self.focus_force()
        self.focus_force() # Keep focus_force for initial focus
        ...
        self._vigilancia_after_id = None
        self._vigilancia_token = 0
        self._cache_vigilancia_modelo = {}
        self._alerta_preventivo_msg = ""
        self._alerta_preventivo_tooltip = None
        self._vigilancia_habilitada = True
        self._gerando_orcamento = False
        self._gerando_recibo = False
        self._salvando_documento = False
        self._orcamento_em_edicao = bool(id_orc)
        self._ultima_assinatura_item = None
        self._ultimo_item_ts = 0.0
        self._item_em_edicao_id = None
        self._historico_itens_reprovados = []
        self.btn_reativar_item = None
        ...
        self.var_pagamento = ctk.StringVar(value="2X")
        ...
        self.frame_conteudo.grid(row=0, column=1, sticky="nsew", padx=10, pady=10)
        self.setup_campos()
        ...
        try:
            def _resolver_logo_absoluta(caminho_logo, padroes=None):
                ...
                if bruto:
                    ...
                    # Migração de caminho: se vier absoluto antigo, tenta reaproveitar apenas o nome do arquivo.
