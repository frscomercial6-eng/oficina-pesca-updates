...
set "SETUP_NAME=Setup_OficinaPesca_v1.0.61.exe"
set "APK_FIXED=apk_celular_distribuicao\oficina_pesca_v1.0.61.apk"
set "APK_DEBUG=apk_celular_distribuicao\oficina_pesca_v1.0.61.apk"
...
if not exist "%DIST_DIR%\_internal\apk_celular_distribuicao\oficina_pesca_v1.0.61.apk" (
