...
set "FINAL_SETUP=Setup_OficinaPesca_v1.0.47_FINAL.exe"
echo ============================================
...
powershell -NoProfile -Command "& '%ISCC_EXE%' '/DInstallerOutputName=Setup_OficinaPesca_v1.0.47_FINAL' 'instalar.iss'; exit $LASTEXITCODE"
if errorlevel 1 (
